...
class UiRelief(QWidget):
    ...
    def setupUi(self):
        ...
        self.retranslateUi()
        self.n_counter_slider.valueChanged['int'].connect(self.n_slider_box.setValue)
        self.n_slider_box.valueChanged['int'].connect(self.n_counter_slider.setValue)
        self.k_value_slider.valueChanged['int'].connect(self.k_value_box.setValue)
        self.k_value_box.valueChanged['int'].connect(self.k_value_slider.setValue)
        self.grid_size_slider.valueChanged['int'].connect(self.grid_size_box.setValue)
        self.grid_size_box.valueChanged['int'].connect(self.grid_size_slider.setValue)
